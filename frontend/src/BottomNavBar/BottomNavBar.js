  ...
  return (
    <div className={classes.shadow}>
      <BottomNavigation position="fixed" value={value} onChange={handleChange} className={classes.navBar}>
        ...
        />
        <BottomNavigationAction label="Mes Amis" style={{ color: iconColor.friendsColor }} onClick={() => { props.history.push('/friends') }} value={'friendsColor'} 
          icon={
        ...
        />
        <BottomNavigationAction label="Profile" style={{ color: iconColor.profileColor }} value={'profileColor'} onClick={() => { props.history.push(`/profile`) }} 
          icon={
